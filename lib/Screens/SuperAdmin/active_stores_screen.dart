...
class ActiveStoresScreen extends StatefulWidget {
  const ActiveStoresScreen({super.key});

  @override
  State<ActiveStoresScreen> createState() => _ActiveStoresScreenState();
}

class _ActiveStoresScreenState extends State<ActiveStoresScreen> {
                      ...
                      itemBuilder: (context, index) {
                        return Dismissible(
                          ...
                          confirmDismiss: (direction) async {
                            return await showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  title: Text("إلغاء التفعيل"),
                                  content:
                                  Text("هل أنت متأكد أنك تريد إلغاء تفعيل هذا المقهى؟"),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () =>
                          ...
                          background: Container(
                            ...
                            child: Text('إلغاء التفعيل',style: titilliumRegular.copyWith
                              (
                                color: Colors.white,
                                fontSize: 18.sp
                            ),),
